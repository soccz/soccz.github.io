...
> **🧒 한 줄 요약**: "신경망이 *어디를 봤는지* 보여주는 attention 의 *그림* 이 사실 *모델이 어디를 보고 결정했는지* 와 다를 수 있다 — 7 년간 의료/금융/법률 도메인에서 이 그림을 *근거* 로 결정을 내려왔는데, 그 근거가 *위험* 할 수 있다." 본 챕터는 이 문제의 *실세계 예시 3개* + *왜 학계가 이 문제를 늦게 알아챘는가* 의 *5 단계 lineage*.
