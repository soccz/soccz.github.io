...
```viz:tappa-pattern-types:title=5 Attention Pattern Types,caption=Pattern selector. 5 visual types of attention patterns.
```
...
1. **3 층 의의?**
2. **Q-sim × RoPE 2-axis 의 power?**
3. **5 pattern types 의 exhaustive?**
