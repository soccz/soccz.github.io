...
**쉬운 말 풀이.** 시험지 앞장에서 똑같이 생긴 문제를 찾아 답을 베끼는 학생이 3년간 교과서를 외운 학생을 이겼다. "정답을 몇 개 맞혔나"(점별 정확도)뿐 아니라 "답안지 전체 분위기가 정답지와 얼마나 닮았나"(어트랙터 재구성)에서도 이겼다. 다만 베끼기 학생의 답은 **같은 답을 계속 반복**하는 형태라, 정답의 "예측 불가능함" 자체는 흉내 내지 못한다.
