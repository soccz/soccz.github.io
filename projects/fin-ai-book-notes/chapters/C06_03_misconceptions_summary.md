...
> **원서 위치**: 김태헌, 《금융 AI의 이해》(제이펍, 2024), §6.4 (pp.322–324), §6.5 (pp.324~)
> **원서 분량**: 약 3쪽 (4가지 오해 + 마무리)
...
### 입문
1. 이 책 (《금융 AI의 이해》, 김태헌, 2024)
2. 《퀀트 전략을 위한 인공지능 트레이딩》 (김태헌, 2020) — 같은 저자
